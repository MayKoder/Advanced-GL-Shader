...
bool ModuleRenderer3D::Init()
{
	...
	std::vector<std::string> faces = {
		"assets/Skybox/right.dds",
		"assets/Skybox/left.dds",
		"assets/Skybox/top.dds",
		"assets/Skybox/bottom.dds",
		"assets/Skybox/front.dds",
		"assets/Skybox/back.dds"
	};
...
//	{
//		const GL_Object* _mesh = (*i).second->_mesh;
//		if (_mesh)
//		{
